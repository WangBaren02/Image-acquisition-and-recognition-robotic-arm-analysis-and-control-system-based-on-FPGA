...
// (
	...
	// //Image data prepred to be processd
	// .per_frame_vsync	(dil_vsync			),	//Prepared Image data vsync valid signal
	// .per_frame_href		(dil_href			),		//Prepared Image data href vaild  signal
	// .per_frame_clken	(dil_clken			),	//Prepared Image data output/capture enable clock
	// .per_img_Bit		(dil_bit			),		//Prepared Image Bit flag outout(1: Value, 0:inValid)

	// //Image data has been processd
	// .post_frame_vsync	(dil2_vsync		),	//Processed Image data vsync valid signal
	// .post_frame_href	(dil2_href			),	//Processed Image data href vaild  signal
	// .post_frame_clken	(dil2_clken			),	//Processed Image data output/capture enable clock
	// .post_img_Bit		(dil2_bit			)	//Processed Image Bit flag outout(1: Value, 0:inValid)
// );
...
// (
	...
	// //Image data has been processd
	// .post_frame_vsync	(ero3_vsync	),	//Processed Image data vsync valid signal
	// .post_frame_href	(ero3_href	),	//Processed Image data href vaild  signal
	// .post_frame_clken	(ero3_clken	),	//Processed Image data output/capture enable clock
	// .post_img_Bit		(ero3_bit	)	//Processed Image Bit flag outout(1: Value, 0:inValid)
// );
...
// (
	// .clk				(clk			),
	// .rst_n				(rst_n			),
	// .href_in			(connect_href_out	),
	// .vsync_in			(connect_vsync_out	),//取反输入
	// .de_in				(connect_de_out		),
	// .din_in				(connect_bin_out  	),
